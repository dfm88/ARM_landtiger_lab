...
void draw_score(int value, int player)
{
    ...
    GUI_Text(start, 160, (unsigned char *)text, Black, Black);
    sprintf(text, "%d", value);
    GUI_Text(start, 160, (uint8_t *)text, White, Black);
}
...
void GAME_init(void)
{
    ...
    draw_score(score1, 1);
    draw_score(score2, 2);
    GUI_Text(38, 305, (unsigned char *)"Press Key1 to start", White, Black);
}
...
void game_over(int winner)
{
    ...
    GUI_Text(90, lose_msg_high, (unsigned char *)"You lose", Red, Black);
    GUI_Text(90, win_msg_high, (unsigned char *)"You win", Green, Black);
...
void start_game()
{
    ...
    GUI_Text(38, 305, (unsigned char *)"                   ", Black, Black);
...
void prepare_restart_game()
{
    ...
    // delete "You lose/ you win"
    GUI_Text(80, 180, (unsigned char *)"           ", Black, Black);
...
{
    // delete "Press Key1 to start"
    GUI_Text(38, 305, (unsigned char *)"                   ", White, Black);
    resume_game();
}
